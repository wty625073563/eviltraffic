export const FAQS_EN = [
  {
    title: "Is it against Instagram's policy to buy followers?",
    content:
      "Of course not. Instagram can't delete followers or ban you just because you have followers."
  },
  {
    title: 'How long will it take to get my followers?',
    content:
      'It depends on stock availability and how many followers you want to receive. You will see the estimated time next to it when you enter the number you want to receive.'
  },
  {
    title: 'Is it safe to buy Instagram followers?',
    content:
      'Yes, as we mentioned in the article, we provide a safe environment. We never ask for any important information and our system is protected by an SSL certificate.'
  },
  {
    title: 'Will I get banned for buying followers?',
    content:
      "Absolutely not. It's no different than having your friends follow your account. None of our clients have come to complain about their account status on Instagram."
  },
  {
    title: 'How many Instagram followers should I buy?',
    content:
      "It's totally up to you. You can buy as many or as few as you want, and you don't have to buy them all at once."
  },
  {
    title: "Can I get a refund if I'm not satisfied with the service?",
    content:
      'We only issue refunds if we are unable to fulfill the order within the specified time frame. If the estimated time is less than 3 days, it will be extended to 3 business days.'
  },
  {
    title: 'Is it common to buy followers?',
    content:
      'It is very common, because if you buy followers you will reach your goals in a very short time. This is why many personal and business profiles prefer to buy followers.'
  },
  {
    title: 'Is Instagram also dropping followers?',
    content:
      'No. There has been no public announcement about this. Therefore, we do not expect the following counts to be deleted in a short period of time. Your followers will be visible.'
  },
  {
    title: 'Why should you buy Instagram followers?',
    content:
      'Buying Instagram followers can help you get results faster. It can also help you gain more organic followers, as your follower count will provide social proof for your project or business.'
  },
  {
    title: 'Why do I need to make my account public to buy?',
    content:
      'Instagram does not allow any non-authorized users to see private profiles. Therefore, you can understand why we need access. However, you can then make your account private again.'
  },
  {
    title: 'Is it legal to buy Instagram followers?',
    content: 'Technically, it is not illegal to buy followers.'
  },
  {
    title: 'Does having a lot of followers on my profile help with organic engagement?',
    content:
      'Yes! When you have a lot of real and active followers on your profile, you are like a local celebrity and people will notice. Therefore, users with a lot of legitimate followers will attract the attention of potential organic followers.'
  },
  {
    title: 'Will hashtags get me followers on Instagram?',
    content:
      'Hashtags are a great way to expand your social reach. If you have a lot of followers, your posts can be seen on the Explore page by using the right hashtags.'
  },
  {
    title: 'But why should I pay for fake followers?',
    content:
...
export const FAQS_ZH = [
  {
    title: 'Instagram是否禁止品牌购买粉丝？',
    content: '显然，这不是真的。Instagram不能删除粉丝或禁止你，因为你有粉丝。'
  },
  {
    title: '我要多久才能收到我的粉丝？',
    content:
      '这取决于库存状况以及你希望获得多少追随者。当你输入你想要收到的数字时，你会在它旁边看到估计的时间。'
  },
  {
    title: '购买Instagram粉丝安全吗？',
    content:
      '是的，正如我们在文章中所说的，我们提供了一个安全的环境。我们从不询问重要信息，我们的系统是由SSL证书保护的。'
  },
  {
    title: '我买粉丝会被禁吗？',
    content:
      '绝对不会。这和让朋友关注你的账户没什么区别。我们的客户中没有人来投诉他们在Instagram上的账户状态。'
  },
  {
    title: '我应该买多少Instagram粉丝？',
    content: '这完全取决于你。你想买多少就买多少，不必一次买完。'
  },
  {
    title: '如果我对服务不满意，可以退款吗？',
    content:
      '只有当我们不能在规定的时间内兑现承诺时，才能退款。如果预计时间少于3天，则延长到3个工作日。'
  },
  {
    title: '购买粉丝很常见吗？',
    content:
      '这是很常见的，因为如果你买了追随者，你将在很短的时间内达到你的目标。这就是为什么许多个人和商业资料更喜欢购买关注者。'
  },
  {
    title: 'Instagram的粉丝数也在减少吗？',
    content:
      '不会。关于这一点还没有公开声明。因此，我们不希望以下计数在短时间内被删除。你的追随者将会可见。'
  },
  {
    title: '你为什么要买Instagram的粉丝？',
    content:
      '购买Instagram粉丝可以帮助你更快获得效果。它还可以帮助你获得更多的有机追随者，因为你的追随者数量将为你的项目或业务发展提供参考。'
  },
  {
    title: '为什么我要公开我的帐户购买？',
    content:
      'Instagram不允许任何非允许用户看到隐藏的个人资料。因此，您可以理解为什么我们需要访问。不过，之后你可以把你的账户隐藏起来。'
  },
  {
    title: '购买Instagram粉丝合法吗？',
    content: '从技术上讲，购买粉丝并不违法。'
  },
  {
    title: '在我的个人资料上有许多关注者是否有助于吸引有机参与？',
    content:
      '是的！当你的个人资料上有许多真实且活跃的粉丝时，你就像是一个当地的名人，人们会注意到这一点。因此，拥有大量合法粉丝的用户会吸引潜在有机粉丝的注意。'
  },
  {
    title: 'Instagram上的标签会有粉丝吗？',
    content:
      '标签是扩展你的社交范围的好方法。如果你有很多关注者，你的文章可以通过使用适当的标签在Explore页面上看到。'
  },
  {
    title: '但我为什么要花钱买假粉丝呢？',
    content:
  ...
  },
  {
    title: '我买的粉丝如何帮助我的账户？',
    content:
      '当你为我们的服务付费时，你保证会收到有针对性的、真实的和活跃的追随者，他们会为你的能见度做出贡献，让你的支付物有所值。把我们当成购买Instagram粉丝的最佳场所吧。'
  }
]

export const FAQS_JA = [
  {
    title: 'Instagramのポリシーに従ってフォロワーを購入することは許可されていますか？',
    content:
      'もちろんです。Instagramは、フォロワーがいるからといって、フォロワーを削除したりアカウントを禁止することはありません。'
  },
  {
    title: 'フォロワーを手に入れるのにどれくらい時間がかかりますか？',
    content:
      '在庫の可用性や欲しいフォロワーの数によって異なります。欲しい数を入力すると、見積もり時間が表示されます。'
  },
  {
    title: 'Instagramのフォロワーを購入するのは安全ですか？',
    content:
      'はい、この記事で述べたように、安全な環境を提供しています。重要な情報を求めることはありませんし、SSL証明書でシステムが保護されています。'
  },
  {
    title: 'フォロワーを購入するとアカウントが禁止されますか？',
    content:
      '絶対にそうではありません。友達にフォローしてもらうのと変わりません。Instagramでアカウントの状態に関するクレームを受けたクライアントはいません。'
  },
  {
    title: '何人のInstagramフォロワーを購入すべきですか？',
    content:
      '完全にあなた次第です。欲しい数だけ購入できますし、一度にすべてを購入する必要はありません。'
  },
  {
    title: 'サービスに満足しない場合に返金を受けることはできますか？',
    content:
      '指定された時間枠内に注文を完了できない場合にのみ返金を行います。見積もり時間が3日未満の場合は、3営業日に延長されます。'
  },
  {
    title: 'フォロワーを購入することは一般的ですか？',
    content:
      '非常に一般的です。フォロワーを購入すると、非常に短期間で目標を達成できます。そのため、多くの個人やビジネスプロフィールがフォロワーを購入することを好むのです。'
  },
  {
    title: 'Instagramもフォロワーを減らすことがありますか？',
    content:
      'いいえ。これに関する公式発表はありません。したがって、短期間でフォロワー数が削除されることは予想されません。フォロワーは表示されます。'
  },
  {
    title: 'なぜInstagramフォロワーを購入すべきですか？',
    content:
      'Instagramフォロワーを購入することで、結果をより速く得ることができます。フォロワー数があることで、プロジェクトやビジネスに対する社会的証明が提供され、より多くの有機的なフォロワーを獲得するのに役立ちます。'
  },
  {
    title: 'なぜアカウントを公開する必要があるのですか？',
    content:
      'Instagramは、非承認ユーザーにプライベートプロフィールを見せることを許可していません。そのため、アクセスが必要な理由が理解できます。ただし、その後アカウントを再びプライベートにすることができます。'
  },
  {
    title: 'Instagramフォロワーを購入することは合法ですか？',
    content: '技術的には、フォロワーを購入することは違法ではありません。'
  },
  {
    title: 'プロフィールにたくさんのフォロワーがいると、有機的なエンゲージメントに役立ちますか？',
    content:
      'はい！プロフィールにたくさんの実際のアクティブなフォロワーがいると、地元の有名人のような存在になり、人々の注意を引きます。したがって、多くの正規のフォロワーを持つユーザーは、潜在的な有機的フォロワーの注意を引きます。'
  },
  {
    title: 'ハッシュタグはInstagramでフォロワーを増やすのに役立ちますか？',
    content:
      'ハッシュタグはソーシャルリーチを拡大する素晴らしい方法です。適切なハッシュタグを使用することで、多くのフォロワーがいると、あなたの投稿がExploreページで表示されることがあります。'
  },
  {
    title: 'なぜ偽のフォロワーのために支払う必要があるのですか？',
    content:
      '当社のサービスを利用すると、偽のInstagramフォロワーに支払うことはありません！当社のパッケージのすべてのIGフォロワーは実在のアカウントです。最も売れ筋のフォロワーについて詳しく知りたい場合は、当社のInstagramカスタマーサービスにお問い合わせください。'
  },
  {
    title: '購入したフォロワーは時間とともに消えたり減少しますか？',
    content:
      'フォロワー数は減少しません、それは保証です。購入後の6か月間、可能な減少に対する補償を保証します。'
  },
  {
    title: '購入したフォロワーがアカウントにどのように役立ちますか？',
    content:
      '当社のサービスを利用すると、ターゲットを絞った、実在のアクティブなフォロワーを受け取ることが保証され、あなたの可視性に貢献し、支払いが価値あるものになります。当社をInstagramフォロワーを購入するための最高の場所と考えてください。'
  }
]
