...
const ZH = {
  hero: {
    title: '购买',
    description:
      '让我们的 Dribbble 推广服务助您在设计师社区中脱颖而出！我们提供增粉、增评论等一站式推广方案，让您的作品在热门射手榜上熠熠生辉。选择我们，让曝光不再是奢望，引领您的设计人生步入全新的广阔舞台！',
    title1: 'Dribbble',
    btn: '立即购买',
    image: imageUrl
  },
  productsTitle: 'Dribbble 服务',
  products: [
    {
      icon: 'BiCommentDetail',
      title: 'Dribbble Comments',
      description:
        '提高您的Dribbble作品的曝光率和参与度,让更多设计爱好者留下宝贵评论。我们的Dribbble Comments服务可以为您带来真实、高质量的评论,增加作品的互动性,提升您在设计界的影响力。'
    },
    {
      icon: 'BiUser',
      title: 'Dribbble Followers',
      description:
        '扩大您的Dribbble粉丝群体,让更多人关注您的设计作品。我们的Dribbble Followers服务可以为您带来真实、高质量的粉丝,提高您在设计社区的知名度和影响力,让您的作品得到更多曝光和赞赏。'
    },
    {
      icon: 'BiLike',
    ...
    },
    {
      ...
      description:
        '让更多人收藏您出色的Dribbble作品,提高作品的收藏率。我们的Dribbble Saves服务可以为您带来真实、高质量的收藏量,确保您的设计作品被更多人珍视和保存,提升您在设计界的专业形象。'
    },
    {
      icon: 'BiShareAlt',
      title: 'Dribbble Shares',
      description:
        '让您的Dribbble作品在设计社区中广为流传,提高作品的分享率。我们的Dribbble Shares服务可以为您带来真实、高质量的分享量,确保您的设计作品被更多人传播和分享,扩大您在设计界的影响力。'
    }
  ],
  faqs: [
    {
      title: '在 Dribbble 上进行推广是否合法?',
      content:
        'Dribbble 允许用户进行付费推广,只要遵守他们的社区指南和政策,就不会有任何问题。我们提供的服务完全合法合规。'
    },
    {
      title: '使用 Dribbble 推广服务需要多长时间才能见效?',
      content:
        '这取决于您选择的推广方案和预算。我们会根据您的具体需求提供预计的交付时间。通常情况下,3-7个工作日内就能看到初步效果。'
    },
    {
      title: 'Dribbble 推广服务是否安全可靠?',
      content:
        '我们的系统采用业界领先的安全技术,如SSL加密等,确保您的隐私和资金安全。我们从未要求您提供任何敏感信息。'
    },
    {
      title: '如何确定我需要购买多少 Dribbble 推广服务?',
      content:
        '这取决于您的具体推广目标和预算。我们可以根据您的需求提供专业建议,帮助您选择合适的推广方案。您也可以分批次购买,灵活调整。'
    },
    {
      title: '如果对 Dribbble 推广服务不满意,可以退款吗?',
      content:
        '如果我们无法在承诺的时间内完成您的订单,我们会主动为您退款。除此之外,只要您对服务质量不满意,我们也会全额退款。'
    },
    {
      title: '在 Dribbble 上进行付费推广是否普遍?',
      content:
        '是的,许多设计师和创意从业者都会选择在 Dribbble 上进行付费推广,因为这是一个高度专业、高质量的设计社区,可以快速获得目标受众的关注。'
    }
  ]
}
