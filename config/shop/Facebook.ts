...
const ZH = {
  hero: {
    title: '购买',
    description:
      '在这个时代，每个人都可以成为内容创作者。你是否希望在Facebook上获得更多曝光和影响力？我们提供专业的Facebook推广服务：精准增粉、评论互动、热门内容推广等，助您在社交媒体中脱颖而出。我们的团队深谙Facebook生态，能帮助您精准定位目标受众，积累高质量粉丝群体，引起关注并推广您的作品。无论个人品牌还是企业营销，选择我们，让您在Facebook上获得更大的影响力！',
    title1: 'Facebook',
    btn: '立即购买',
    image: imageUrl
  },
  productsTitle: 'Facebook 服务',
  products: [
    {
      icon: 'BiLike',
      title: 'Facebook Post Likes',
      description:
        '在社交媒体时代,帖子的点赞数量直接决定了您内容的受欢迎程度和影响力。购买Facebook Post Likes服务,可以为您带来真实、高质量的点赞,有效提升帖子的人气和吸引力,让您在Facebook上脱颖而出,吸引更多关注。'
    },
    {
      icon: 'BiCommentDetail',
      title: 'Facebook Comments',
      description:
        '评论是衡量帖子参与度的重要指标,高质量的评论不仅能增加互动,还能提升内容的价值。购买Facebook Comments服务,可以为您带来真实、相关的评论,激发更多讨论,提高您在Facebook上的影响力。'
    },
    {
      icon: 'BiUser',
      title: 'Facebook Friends',
      description:
        '在Facebook上拥有更多好友,不仅能扩大您的社交圈,还能让您的内容获得更多曝光。购买Facebook Friends服务,可以为您带来真实、高质量的好友,提高您在社交媒体上的知名度,让您的内容得到更多赞赏。'
    },
    {
      icon: 'BiShareAlt',
      title: 'Facebook Shares',
      description:
        '分享是内容在社交媒体上传播的关键,高分享率意味着更多人能看到您的内容。购买Facebook Shares服务,可以为您带来真实、高质量的分享量,确保您的内容在Facebook上广为流传,扩大您的影响力。'
    },
    {
      icon: 'BiLike',
      title: 'Facebook Page Likes',
      description:
        '拥有受欢迎的Facebook页面,不仅能提升您的品牌形象,还能吸引更多潜在客户。购买Facebook Page Likes服务,可以为您带来真实、高质量的点赞,增加页面的人气和吸引力,让您在Facebook上脱颖而出。'
    },
    {
      icon: 'BiPlus',
      title: 'Facebook More',
      description:
        '想要在Facebook上获得全面的增长和影响力,单一服务是远远不够的。购买Facebook More服务,可以为您带来真实、高质量的综合增长,包括点赞、评论、分享等,全方位提升您在社交媒体上的知名度和影响力。'
    }
  ],
  faqs: [
    {
      title: '使用Facebook推广服务会违反Facebook的规定吗？',
      content: '不会的。我们的服务完全遵循Facebook的政策和指南，确保您的账户安全不受影响。'
    },
    {
      title: '启动Facebook推广后，多久能看到效果？',
      content:
        '效果的显现时间依赖于多种因素，包括您选择的推广类型和目标受众。大多数情况下，您可以在几天内开始看到推广效果。'
    },
    {
      title: '使用Facebook推广服务安全吗？',
      content:
        '绝对安全。我们重视您的隐私和账户安全，不会索取您的账户密码或其他敏感信息。所有交易都通过安全的支付方式进行。'
    },
    {
      title: '我应该购买多少Facebook推广量？',
      content: '这完全取决于您的目标和预算。我们建议从小规模开始，根据效果逐步增加投入。'
    },
    {
      title: '如果我对Facebook推广服务不满意，能否申请退款？',
      content:
        '我们承诺提供满意保障。如果在约定时间内未达到预期效果，我们将提供退款或额外服务以补偿。'
    },
    {
      title: '许多人都在使用Facebook推广服务吗？',
      content:
        '是的，无论是个人品牌还是企业，许多人都通过Facebook推广服务来扩大影响力和提高品牌知名度。'
    }
  ]
}
